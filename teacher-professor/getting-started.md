...
2. **Enter Your Credentials:** Use the Teacher/Professor login details shared with you (email and password).
...
* **Sidebar Menu:** Located on the left, the sidebar allows you to navigate between features like **My Journey**, **Manage Classes** and more.
